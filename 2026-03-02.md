### 2026-03-02: Will the real malleable software please stand up?
...
Unlike their frontends, Input doesn't try to be better GitHub, it tries to be something totally different.
...
Input lets me bring prototyping [[closer to the context of use]], so I can experiment with new design patterns on top of my own data.
...
I've been calling this design pattern "stateless software". It's not local-first, and it's not backendless software. The backends just cache and proxy your user state to another persistent data store.