...
I've started calling this design pattern _stateless software_. It's not local-first, and it's not backendless software. The backends just cache and proxy your user state to another persistent data store.